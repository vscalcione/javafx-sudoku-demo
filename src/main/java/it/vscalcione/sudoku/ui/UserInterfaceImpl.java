...
public class UserInterfaceImpl implements IUserInterfaceContract.View, EventHandler<KeyEvent> {
     ...
     * is give to the updateUI method, we iterate through it by X and Y coordinates and assign the values to the
     * appropriate TextField therein. This means wer don't need to hold a reference variable for every god damn
     * text field is this app; which would be awful
     * The Key (<Key, Value>) -> <Coordiantes, Integer>) will be the HashCode of a give InputField for ease of lookup
     */
